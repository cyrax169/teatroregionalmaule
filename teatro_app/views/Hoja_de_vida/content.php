...
<table width="" height="1265" border="0" align="center">
  ...
  <tr>
    ...
    <td><table width="200" border="0">
      ...
      <tr>
        ...
        <td><input name="CUENTA2" type="text" value="CUENTA" /></td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <td><p>
      ...
      FIJO <input name="INDEFINIDO" type="radio" value="radiobutton" />
      INDEFINIDO      </p>      </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>BONOS</td>
    <td><input name="BONOS" type="text" value="TIPO DE BONO" />
    <input name="MONTO" type="text" value="MONTO" />
    ( puede ser mas de uno) </td>
  </tr>
  <tr>
    <td>HORAS EXTRAS</td>
    <td>  <input name="HEXTRA" type="text" value="HORAS" /> <input name="HMONTO" type="text" value="$MONTO" /></td>
  </tr>
  <tr>
    <td>ASIGNACIONES</td>
...
(puede ser mas de uno) </td>
  ...
  <tr>
    <td>AFC</td>
    <td><input name="AFCSI" type="radio" value="radiobutton" />
SI
  <input name="AFCNO" type="radio" value="radiobutton" />
NO    (automatica dependiendo del tipo de contrato) </td>
  </tr>
  <tr>
    ...
    Monto personalizado en UF ( dos decimales ) </p></td>
  </tr>
  <tr>
    <td>APV</td>
    <td><p><input name="APVSI" type="radio" value="radiobutton" checked="checked" />
      SI
        <input name="APVNO" type="radio" value="radiobutton" />
      NO (si elije si da las opciones de uf y peso ) </p>
      <table width="200" border="0">
        ...
        <tr>
          <td>PESOS</td>
          <td><input type="text" name="PESOS" /></td>
        </tr>
    </table>      </td>
  </tr>
  <tr>
    <td valign="middle">CARGAS FAMILIARES</td>
    <td><p>
    ...
    NO</p>
      <table width="653" border="1">
        ...
        <tr>
          <td><input type="text" name="NOMBRESCARGA" /></td>
          <td><select name="TIPOCARGA">
            <option selected="selected"> </option>
        ...
        <tr>  <!--Este campo se generará automáticamente por lo que el nombre de las variables no las cambiaré-->
          <td><input type="text" name="textfield22532" /></td>
    ...
    <p>(se deben poder agregas muchas mas , si se elije la opcion no la tabla debe desaparecer) </p></td>
  </tr>
  <tr>
    <td height="120" valign="middle">VACACIONES</td>
    <td><table width="652" height="71" border="1">
      <tr>
      ...
      <tr>
        ...
        <td><input name="TOTALDIAS" type="text" value="CALCULAR" size="20" /></td>
      </tr>
    </table>
      <p>(Total Dias = 1.25 * (total meses trabajados )) ; meses trabajados: si entra antes del 15 se cuenta como mes // se agranda automaticamente todos los a&ntilde;os // se tienen que ver todas las vacaciones anteriores </p>      </td>
  </tr>
  <tr>
    <td valign="middle">LICENCIAS MÉDICAS</td>
    <td><p>DÍAS
    ...
    <input type="text" name="textfield225325" />
      ...
      <p>      1-3 : no se descuentan de los dias trabajados ; 1 - 10 : se empiezan a descontar desde el 4 dia ; 1 - 11: se descuentan todos los dias </p>    </td>
  </tr>
  <tr>
    <td valign="middle">PERMISOS</td>
    <td><p>DÍAS
...
NO (Si es con goCe de sueldo no se le descuentan). </p>    </td>
  </tr>
  <tr>
    <td>PRESTACIONES</td>
    <td><p>INSTITUCIÓN
