...
<link href="http://localhost/sw2/trunk/css/style.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="http://localhost/SW/javascripts/functions.js"></script>
</head>
<body>
<div id="header">
</div><!--Fin Header-->