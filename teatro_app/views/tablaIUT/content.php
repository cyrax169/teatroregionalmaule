        ...
        <table border="1" align="center" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="" value="<?php echo $a;?>" readonly /></td>
                ...
                <tr>
                    <td><input type="text" name="" value="<?php echo $k;?>" readonly /></td>
