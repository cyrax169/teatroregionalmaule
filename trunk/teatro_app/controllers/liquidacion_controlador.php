            ...
            foreach($datos['result'] as $row):
                ...
                for($i=0;$i<2;$i++):
                    ...
                    $this->cezpdf->ezTable($datos1
                        ...
                        ,array('showHeadings'=>0,'shaded'=>0,'showLines'=>2,'xOrientation'=>'centre','width'=>500,'fontSize' => 10,'titleFontSize' => 10)
                    );
                    ...
                    $this->cezpdf->ezTable($datos2
                        ...
                        ,array('showHeadings'=>0,'shaded'=>0,'showLines'=>2,'xOrientation'=>'centre','width'=>500,'fontSize' => 10)
                    );
                    ...
                    $this->cezpdf->ezText("\n");
                    $this->cezpdf->ezText($trm2,8,array('justification'=> 'centre'));
                    $this->cezpdf->ezText($trm3,8,array('justification'=> 'centre'));
                    $this->cezpdf->ezText($trm4,8,array('justification'=> 'centre'));
                    $this->cezpdf->ezText("\n");
                ...
                $this->cezpdf->line(225,354,225,325);
                $this->cezpdf->line(375,828,375,814); //lineas de AFP
                $this->cezpdf->line(375,354,375,340);
                $this->cezpdf->line(375,784,375,770); //lineas de Salud
                $this->cezpdf->line(375,311,375,296);
                $this->cezpdf->line(225,755,225,741); //lineas de Cargas
                $this->cezpdf->line(225,282,225,267);
                $this->cezpdf->addText(228,818,10,$row->CantDias);
                $this->cezpdf->addText(228,344,10,$row->CantDias);
                $this->cezpdf->addText(228,804,10,$row->CantHoras);
                $this->cezpdf->addText(228,329,10,$row->CantHoras);
                $this->cezpdf->addText(377,817,10,$row->NombreAfp);
                $this->cezpdf->addText(377,343,10,$row->NombreAfp);
                $this->cezpdf->addText(377,773,10,$row->NombreSalud);
                $this->cezpdf->addText(377,299,10,$row->NombreSalud);
                $this->cezpdf->addText(228,744,10,$row->Cargas);
                $this->cezpdf->addText(228,270,10,$row->Cargas);
            endforeach;
