                        ...
                        <table border="1" width="100%" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"readonly="readonly" name="NOMBRE<?php echo $i;?>" value="<?=$row->Nombre?>" /></td>
                                    <td><input type="text"readonly="readonly" name="RUT<?php echo $i;?>" value="<?=$row->Rut?>-<?=$row->Digito?>" /></td>
                                    <td><input type="text"readonly="readonly" name="RENTABRUTA<?php echo $i;?>" value="<?=$row->RentaBruta?>" /></td>
                                    <td><input type="text"readonly="readonly" name="DIASTRABAJADOS<?php echo $i;?>" value="<?=$row->DiasTrabajados?>" /></td>
                                    <td><input type="text"readonly="readonly" name="HORASEXTRAS<?php echo $i;?>" value="<?=$row->HorasExtras?>" /></td>
                                    <td><input type="text"readonly="readonly" name="AGUINALDO<?php echo $i;?>" value="<?=$row->OtrosBonos?>" /></td>
                                    <td><input type="text"readonly="readonly" name="RENTAIMPONIBLE<?php echo $i;?>" value="<?=$row->RentaImponible?>" /></td>
                                    <td><input type="text"readonly="readonly" name="ACAJAOTROS<?php echo $i;?>" value="<?=$row->AcajaOtro?>" /></td>
                                    <td><input type="text"readonly="readonly" name="NUMCARGA<?php echo $i;?>" value="<?=$row->NumCargas?>" /></td>
                                    <td><input type="text"readonly="readonly" name="ASIGNACIONFAMILIAR<?php echo $i;?>" value="<?=$row->AsignacionFamiliar?>" /></td>
                                    <td><input type="text"readonly="readonly" name="TOTALHABERES<?php echo $i;?>" value="<?=$row->TotalHaberes?>" /></td>
                                   <?php $Nombreafp=$row->NombreAfp;?>
                                    <?php if($Nombreafp=='Capital'):?>
                                    <td><input type="text"readonly="readonly" name="PROVIDA<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="HABITAT<?php echo $i;?>"value="0"</td>
                                    <td><input type="text"readonly="readonly" name="CAPITAL<?php echo $i;?>" value="<?=$row->MontoAfp?>" /></td>
                                    <td><input type="text"readonly="readonly" name="CUPRUM<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="PLAN VITAL<?php echo $i;?>" value="0" /></td>
                                    <?php endif;?>
                                     <?php if($Nombreafp=='Habitat'):?>
                                    <td><input type="text"readonly="readonly" name="PROVIDA<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="HABITAT<?php echo $i;?>"value="<?=$row->MontoAfp?>"</td> <!--Nosé si va-->
                                    <td><input type="text"readonly="readonly" name="CAPITAL<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="CUPRUM<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="PLAN VITAL<?php echo $i;?>" value="0" /></td>
                                    <?php endif;?>
                                     <?php if($Nombreafp=='Cuprum'):?>
                                    <td><input type="text"readonly="readonly" name="PROVIDA<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="HABITAT<?php echo $i;?>"value="0"</td> <!--Nosé si va-->
                                    <td><input type="text"readonly="readonly" name="CAPITAL<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="CUPRUM<?php echo $i;?>" value="<?=$row->MontoAfp?>" /></td>
                                    <td><input type="text"readonly="readonly" name="PLAN VITAL<?php echo $i;?>" value="0" /></td>
                                    <?php endif;?>
                                    ...
                                    <td><input type="text"readonly="readonly" name="CAPITAL<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="CUPRUM<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="PLAN VITAL<?php echo $i;?>" value="<?=$row->MontoAfp?>" /></td>
                                    <?php endif;?>
                                    <?php if($Nombreafp=='Provida'):?>
                                    <td><input type="text"readonly="readonly" name="PROVIDA<?php echo $i;?>" value="<?=$row->MontoAfp?>" /></td>
                                    <td><input type="text"readonly="readonly" name="HABITAT<?php echo $i;?>"value="0"</td> <!--Nosé si va-->
                                    <td><input type="text"readonly="readonly" name="CAPITAL<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="CUPRUM<?php echo $i;?>" value="0" /></td>
                                    <td><input type="text"readonly="readonly" name="PLAN VITAL<?php echo $i;?>" value="0" /></td>
                                    <?php endif;?>
                                    <td><input type="text"readonly="readonly" name="AFC<?php echo $i;?>" value="<?=$row->Afc?>" /></td>
                                  
                                    <td><input type="text"readonly="readonly" name="ISAPREVARIOS<?php echo $i;?>" value="<?=$row->MontoIsapre?>" /></td>
                                  
                                    <td><input type="text"readonly="readonly" name="ISAPREADICIONAL<?php echo $i;?>" value="<?=$row->IsapreAdicional?>" /></td>
                                 
                                    <td><input type="text"readonly="readonly" name="NOMBREISAPRE<?php echo $i;?>" value="<?=$row->NombreIsapre?>"
                               
                                    <td><input type="text"readonly="readonly" name="FONASA<?php echo $i;?>" value="<?=$row->Fonasa?>" /></td>
                                    <td><input type="text"readonly="readonly" name="LOSANDES<?php echo $i;?>" value="<?=$row->LosAndes?>" /></td>
                                    <td><input type="text"readonly="readonly" name="APV<?php echo $i;?>" value="<?=$row->Apv?>" /></td>
                                    <td><input type="text"readonly="readonly" name="TOTALDESCUENTOSLEGALES<?php echo $i;?>" value="<?=$row->TotalDescuentosLegales?>" /></td>
                                    <td><input type="text"readonly="readonly" name="BaseImpueto<?php echo $i;?>" value="<?=$row->BaseImpuesto?>" /></td>
                                    <td><input type="text"readonly="readonly" name="IPM.UNI<?php echo $i;?>" value="<?=$row->IpmUni?>" /></td>
                                    <td><input type="text"readonly="readonly" name="CREDITOS<?php echo $i;?>" value="<?=$row->Prestamos?>" /></td>
                                    <td><input type="text"readonly="readonly" name="ANTICIPOS<?php echo $i;?>" value="<?=$row->AnticiposOtros?>" /></td>
                                    <td><input type="text"readonly="readonly" name="TOTALDESCUENTOSADICIONALES<?php echo $i;?>" value="<?=$row->TotalDescuentosAdicionaes?>" /></td>
                                    <td><input type="text"readonly="readonly" name="TOTALLIQUIDO<?php echo $i;?>" value="<?=$row->TotalLiquido?>" /></td>
                                    <td><input type="text"readonly="readonly" name="AFC2<?php echo $i;?>" value="<?=$row->Afctrabajador?>" /></td>
                                    <td><input type="text"readonly="readonly" name="AFC3<?php echo $i;?>" value="<?=$row->Afctrabajador1?>" /></td>
                                    <td><input type="text"readonly="readonly" name="APORTE<?php echo $i;?>" value="<?=$row->Aporte?>" /></td>
